...
public class GetThumbnailAction extends RestAction<InputStream> {
    ...
    public GetThumbnailAction(@NotNull CognitiveContext cognitiveContext, int width, int height, boolean smartCropping, @NotNull Object image) {
