...
public class MergeImagesFilter implements ImageFilter {
    ...
    private int existingImageY(BufferedImage bufferedImage) {
        switch (position) {
            ...
            case RIGHT:
                return 0;
            case TOP:
                return mergeImage.getHeight() + insets.bottom;
            case BOTTOM:
                return 0;
        }
        return 0;
    ...
    private int existingImageX(BufferedImage bufferedImage) {
        switch (position) {
            case LEFT:
                return mergeImage.getWidth() + insets.right;
            case RIGHT:
                return 0;
            case TOP:
                return 0;
    ...
    private int newImageX(BufferedImage bufferedImage) {
        switch (position) {
            case LEFT:
                return insets.left;
            case RIGHT:
                return bufferedImage.getWidth() + insets.right;
            case TOP:
                return insets.left;
            case BOTTOM:
    ...
    protected int calculateNewHeight(@NotNull BufferedImage bufferedImage) {
        switch (position) {
            case LEFT:
            case RIGHT:
                return Math.max(bufferedImage.getHeight(), mergeImage.getHeight()) + insets.top + insets.bottom;
            case TOP:
            case BOTTOM:
                return bufferedImage.getHeight() + mergeImage.getHeight() + insets.top + insets.bottom;
        }
        return 0;
    }
    ...
    protected int calculateNewWidth(@NotNull BufferedImage bufferedImage) {
        switch (position) {
            case LEFT:
            case RIGHT:
                return bufferedImage.getWidth() + mergeImage.getWidth() + insets.left + insets.right;
            case TOP:
            case BOTTOM:
                return Math.max(bufferedImage.getWidth(), mergeImage.getWidth()) + insets.left + insets.right;
        }
        return 0;
    }
